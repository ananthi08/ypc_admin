...
this.database.getData(`ypc-admin-micro-service/gettemplate/${this.id}`).subscribe(
  (result: any[]) => {
    ...
    //console.log('hi',this.nationalCuisine);
    ...
    this.selectedDishList = this.nationalCuisine.chartDetails[0]['chart'][0]['monday'].maindish[0]['breakfast'];
    // //console.log("monday",this.dishSelect)
    this.selectedDishList1 = this.nationalCuisine.chartDetails[0]['chart'][0]['monday'].maindish[0]['lunch'];
    this.selectedDishList2 = this.nationalCuisine.chartDetails[0]['chart'][0]['monday'].maindish[0]['dinner'];
    this.selectedDishList3 = this.nationalCuisine.chartDetails[0]['chart'][1]['tuesday'].maindish[0]['breakfast'];
    this.selectedDishList4 = this.nationalCuisine.chartDetails[0]['chart'][1]['tuesday'].maindish[0]['lunch'];
    this.selectedDishList5 = this.nationalCuisine.chartDetails[0]['chart'][1]['tuesday'].maindish[0]['dinner'];
    this.selectedDishList6 = this.nationalCuisine.chartDetails[0]['chart'][2]['wednesday'].maindish[0]['breakfast'];
    this.selectedDishList7 = this.nationalCuisine.chartDetails[0]['chart'][2]['wednesday'].maindish[0]['lunch'];
    this.selectedDishList8 = this.nationalCuisine.chartDetails[0]['chart'][2]['wednesday'].maindish[0]['dinner'];
    this.selectedDishList9 = this.nationalCuisine.chartDetails[0]['chart'][3]['thursday'].maindish[0]['breakfast'];
    this.selectedDishList10 = this.nationalCuisine.chartDetails[0]['chart'][3]['thursday'].maindish[0]['lunch'];
    this.selectedDishList11= this.nationalCuisine.chartDetails[0]['chart'][3]['thursday'].maindish[0]['dinner'];
    this.selectedDishList12= this.nationalCuisine.chartDetails[0]['chart'][4]['friday'].maindish[0]['breakfast'];
    this.selectedDishList13= this.nationalCuisine.chartDetails[0]['chart'][4]['friday'].maindish[0]['lunch'];
    this.selectedDishList14 = this.nationalCuisine.chartDetails[0]['chart'][4]['friday'].maindish[0]['dinner'];
    this.selectedDishList15= this.nationalCuisine.chartDetails[0]['chart'][5]['saturday'].maindish[0]['breakfast'];
    this.selectedDishList16 = this.nationalCuisine.chartDetails[0]['chart'][5]['saturday'].maindish[0]['lunch'];
    this.selectedDishList17= this.nationalCuisine.chartDetails[0]['chart'][5]['saturday'].maindish[0]['dinner'];
    this.selectedDishList18= this.nationalCuisine.chartDetails[0]['chart'][6]['sunday'].maindish[0]['breakfast'];
    this.selectedDishList19= this.nationalCuisine.chartDetails[0]['chart'][6]['sunday'].maindish[0]['lunch'];
    this.selectedDishList20= this.nationalCuisine.chartDetails[0]['chart'][6]['sunday'].maindish[0]['dinner'];
    
    this.selectedSideDishList = this.nationalCuisine.chartDetails[0]['chart'][0]['monday'].sidedish[0]['breakfast'];
    this.selectedSideDishList1 = this.nationalCuisine.chartDetails[0]['chart'][0]['monday'].sidedish[0]['lunch'];
    this.selectedSideDishList2 = this.nationalCuisine.chartDetails[0]['chart'][0]['monday'].sidedish[0]['dinner'];
    this.selectedSideDishList3 = this.nationalCuisine.chartDetails[0]['chart'][1]['tuesday'].sidedish[0]['breakfast'];
    this.selectedSideDishList4= this.nationalCuisine.chartDetails[0]['chart'][1]['tuesday'].sidedish[0]['lunch'];
    this.selectedSideDishList5= this.nationalCuisine.chartDetails[0]['chart'][1]['tuesday'].sidedish[0]['dinner'];
    this.selectedSideDishList6 = this.nationalCuisine.chartDetails[0]['chart'][2]['wednesday'].sidedish[0]['breakfast'];
    this.selectedSideDishList7= this.nationalCuisine.chartDetails[0]['chart'][2]['wednesday'].sidedish[0]['lunch'];
    this.selectedSideDishList8 = this.nationalCuisine.chartDetails[0]['chart'][2]['wednesday'].sidedish[0]['dinner'];
    this.selectedSideDishList9 = this.nationalCuisine.chartDetails[0]['chart'][3]['thursday'].sidedish[0]['breakfast'];
    this.selectedSideDishList10= this.nationalCuisine.chartDetails[0]['chart'][3]['thursday'].sidedish[0]['lunch'];
    this.selectedSideDishList11= this.nationalCuisine.chartDetails[0]['chart'][3]['thursday'].sidedish[0]['dinner'];
    this.selectedSideDishList12= this.nationalCuisine.chartDetails[0]['chart'][4]['friday'].sidedish[0]['breakfast'];
    this.selectedSideDishList13= this.nationalCuisine.chartDetails[0]['chart'][4]['friday'].sidedish[0]['lunch'];
    this.selectedSideDishList14= this.nationalCuisine.chartDetails[0]['chart'][4]['friday'].sidedish[0]['dinner'];
    this.selectedSideDishList15= this.nationalCuisine.chartDetails[0]['chart'][5]['saturday'].sidedish[0]['breakfast'];
    this.selectedSideDishList16 = this.nationalCuisine.chartDetails[0]['chart'][5]['saturday'].sidedish[0]['lunch'];
    this.selectedSideDishList17= this.nationalCuisine.chartDetails[0]['chart'][5]['saturday'].sidedish[0]['dinner'];
    this.selectedSideDishList18= this.nationalCuisine.chartDetails[0]['chart'][6]['sunday'].sidedish[0]['breakfast'];
    this.selectedSideDishList19= this.nationalCuisine.chartDetails[0]['chart'][6]['sunday'].sidedish[0]['lunch'];
    this.selectedSideDishList20= this.nationalCuisine.chartDetails[0]['chart'][6]['sunday'].sidedish[0]['dinner'];
